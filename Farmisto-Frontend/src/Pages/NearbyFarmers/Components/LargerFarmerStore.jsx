...
const LargerFarmerStore = ({ products, addToCart, handleQuantityChange, quantities }) => {
  ...
  return (
    <div className="w-full flex flex-row gap-6 p-6 ">
      ...
      <div className="w-1/4 bg-gradient-to-br from-green-50 via-green-100 to-green-200 rounded-2xl shadow-md p-4 flex flex-col gap-3">
            ...
            {filteredProducts.map((product) => (
              ...
              >
                ...
                <button
                  ...
                  className="bg-emerald-500 hover:bg-emerald-600 text-white px-4 py-2 rounded-lg flex items-center gap-2 text-md"
                >
